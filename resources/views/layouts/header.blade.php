...
<link href="https://fonts.googleapis.com/css2?family=Montserrat:ital,wght@0,100..900;1,100..900&display=swap" rel="stylesheet">
  ...
  <div>
    ...
    <a href="{{url('vendor/signup')}}"class="text-decoration-none Text-light">Become a seller</a>
    ...
    <div class="collapse navbar-collapse justify-content-center" id="navbarNav">
      <ul class="nav text-dark">
        <li class="nav-item">
          ...
          <a class="nav-link dropdown-toggle text-dark" href="{{url('category/electronics')}}" role="button" data-bs-toggle="dropdown" aria-expanded="false"> T-Shirt
          </a>
          <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="{{url('category/electronics/tv')}}">Half T- shirt </a></li>
            <li><a class="dropdown-item" href="#">Full T-shrt</a></li>
            <li><a class="dropdown-item" href="#">maggi t-shirt</a></li>
          </ul>
        </li>
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="{{url('category/electronics/tv')}}">Seroyani</a></li>
            <li><a class="dropdown-item" href="#">India </a></li>
            <li><a class="dropdown-item" href="#">bangali</a></li>
          </ul>
        </li>
        <li class="nav-item">
